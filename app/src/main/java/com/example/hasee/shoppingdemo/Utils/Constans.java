...
public class Constans {
    ...
    //路径总接口
    //      public static final String CENTENT_URL="http://169.254.206.13:8080";
    public static final String CENTENT_URL="http://169.254.230.253:8080";

    // 请求Json数据基本URL
    public static final String BASE_URL_JSON = CENTENT_URL+"/atguigu/json/";

    // 请求图片基本URL
    public static final String BASE_URl_IMAGE = CENTENT_URL+"/atguigu/img";
    ...
    //分类Fragment里面的分类Fragment页面数据
    public static final String TYPE_URL=BASE_URL_JSON+"type_url.json";
    //新帖
